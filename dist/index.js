...
const notion_1 = __nccwpck_require__(7533);
...
const main = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const response = yield (0, notion_1.getArticles)();
    const articles = [];
    for (const page of response.results) {
        const blocks = yield (0, notion_1.getBlocks)(page.id);
...
class Article {
    ...
    parseBlocks(blocks) {
        const result = (0, NotionBlockParser_1.parseBlocks)(blocks);
        return result;
    }
}
...
\`\`\`\n\n`;
                break;
            case 'image':
                results += yield parseImage(block.image, block.id);
                break;
            default:
...
const parseImage = (image, blockId) => __awaiter(void 0, void 0, void 0, function* () {
    let results = '';
    let savedPath = '';
    switch (image.type) {
        case 'file':
...
const parseImageFile = (url, blockId) => __awaiter(void 0, void 0, void 0, function* () {
    let imagePath = '';
